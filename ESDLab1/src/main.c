...
#define TEMP_LIMIT_UPPER		310
#define TEMP_LIMIT_LOWER		293
#define LOOP_DELAY				1
...
void publishUSARTMessage(volatile uint8_t *, uint8_t);
...
volatile uint8_t received_message[] = "X";
